...
import io.ideploy.deployment.admin.dao.account.MenuDao;
import io.ideploy.deployment.admin.dao.account.MenuResourcesRelationDao;
import io.ideploy.deployment.admin.dao.account.RoleResRelationDao;
import io.ideploy.deployment.admin.dao.account.UrlResourceDao;
import io.ideploy.deployment.admin.po.account.MenuPO;
import io.ideploy.deployment.admin.po.account.MenuResourcesRelationPO;
import io.ideploy.deployment.admin.po.account.UrlResourcePO;
import io.ideploy.deployment.admin.service.account.AdminAccountService;
import io.ideploy.deployment.admin.service.account.MenuService;
import io.ideploy.deployment.admin.service.account.RoleService;
import io.ideploy.deployment.admin.utils.resource.MenuItem;
import io.ideploy.deployment.admin.vo.account.AccountRoleRelation;
import io.ideploy.deployment.admin.vo.account.Menu;
import io.ideploy.deployment.admin.vo.account.RoleMenuRelation;
import io.ideploy.deployment.admin.vo.account.UrlResource;
...
public class MenuServiceImpl implements MenuService {
	...
	private int generateIdForName(boolean isMenu, String name, String url) {
		...
		if (set.contains(code)) {
			...
			throw new ServiceException(ApiCode.FAILURE, (isMenu ? "菜单" : "资源") + "ID重复: " + name);
		}
		// 加入 set
		set.add(code);
