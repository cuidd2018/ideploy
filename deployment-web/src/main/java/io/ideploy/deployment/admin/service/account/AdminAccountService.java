 ...
 */
 public interface AdminAccountService {
	...
	/**
	 * 分页查询帐号信息. 如果keyword参数为空，则显示所有帐号信息；否则模糊查询满足条件的帐号信息
	 *
	 * @param keyword
	 *            用户 keyword 或真实姓名，可为空
	 * @param page
	 *            当前页面 (从1开始)
	 * @param pageSize
	 *            当前页面显示条数
	 ...
	 * @param accountIds
     */
	List<AdminAccount> findByAccountIds(List<Long> accountIds);
}
